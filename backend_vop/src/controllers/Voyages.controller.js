...
module.exports.createHotel = async (req, res) => {
    ...
    let { description, capacite, tarifnuit, equipement, destinationId, } = req.body
...
module.exports.CreateVol = async (req, res) => {
    const { numerovol, compagnieaerienne, aeroportdepart, aeroport, aeroportarrivee, dateheuredepart, dateheurearrivee, destinationId } = req.body
    try {
        await models.Vol.create({ numerovol, compagnieaerienne, aeroportdepart, aeroport, aeroportarrivee, dateheuredepart, dateheurearrivee, destinationId });
        res.status(201).json({
...
module.exports.createReservation = async (req, res) => {
    const { nbadulte, nbbebe, nbchambre, datearrivee, datedepart, destinationId, userId } = req.body
    ...
    // }
    try {
        const reservations = await models.Reservation.create({ nbadulte, nbbebe, nbchambre, datearrivee, datedepart, destinationId, userId })
        res.status(201).json({
